...
wget -O /etc/systemd/system/cloud-torrent.service https://raw.githubusercontent.com/BlackJocker1995/simple-torrent/master/blob/scripts/cloud-torrent.service
